...
parser.add_argument('--eval_nll', action='store_true', help='Evaluate negative log-likelihood')
parser.add_argument('--eval_kantorovich', action='store_true', help='Evaluate Kantorovich distances')
parser.add_argument('--eval_kantorovich_v2', action='store_true', help='Evaluate Kantorovich V2 distances')
parser.add_argument('--eval_mse', action='store_true', help='Evaluate MSE on paths')
